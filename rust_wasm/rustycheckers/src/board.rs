...
#[derive(Debug, Copy, Clone, PartialEq)]
pub struct Coordinate(pub usize, pub usize); // Tuple struct. Default accessors are .0 and .1
impl Coordinate {
    pub fn on_board(self) -> bool {
        let Coordinate(x, y) = self;  // Destructuring to pull x and y out
        x <= 7 && y <= 7
    }

    // Produce an iterator of Coordinates of all possible jumps from given Coordinate
    ...
    // Produce an iterator of Coordinates of all possible moves from given Coordinate
